  ...
  <div class="container w-100 p-0 mt-0 mb-0">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav nav-underline p-3">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="excluir.php"><i class="bi bi-trash-fill"></i> Excluir</a>
        </li>
        <li class="nav-item">
...
<div class="container mt-5 pt-5">
    <h1 class="text-center mb-4 mt-4">Exclusão de Produto</h1>
    <form name="cliente" method="post" action="" onsubmit="return validateForm()">
        <fieldset class="border p-4 mt-2">
            ...
            <div class="mb-3">
                ...
                <input name="txtid" type="text" class="form-control" id="txtnome" placeholder="ID do Produto">
            </div>
        </fieldset>
        <br>
    ...
    <div class="text-center mt-4">
        ...
        <a href="listar.php" class="btn btn-secondary">Ir para a página Listar</a>
    </div>
</div>
